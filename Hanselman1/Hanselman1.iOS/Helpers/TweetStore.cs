...
using Hanselman1.Portable;
using System.IO;
using Newtonsoft.Json;

[assembly: Xamarin.Forms.Dependency(typeof(Hanselman1.iOS.iOSTweetStore))]


namespace Hanselman1.iOS
{
    public class iOSTweetStore : ITweetStore
    {
        public void Save(System.Collections.Generic.List<Hanselman1.Portable.Tweet> tweets)
        {
